...
const props = withDefaults(defineProps<{ modelValue?: number[], options: SelectOptionData[], placeholder?: string, selectAll?: boolean }>(), { placeholder: '选择任意群', selectAll: false })
